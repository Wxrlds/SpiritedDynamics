...
craftingTable.addShaped("eidolon/crafting_table/brazier", <item:eidolon:brazier>, [
...
craftingTable.addShaped("eidolon/crafting_table/stone_hand", <item:eidolon:stone_hand>, [
...
craftingTable.addShaped("eidolon/crafting_table/magic_workbench", <item:eidolon:worktable>, [
...
craftingTable.addShaped("eidolon/crafting_table/candle1", <item:eidolon:candle>, [
    [<item:minecraft:string>],
	[<item:minecraft:honeycomb>],
    [<item:occultism:tallow>]
]);
craftingTable.addShaped("eidolon/crafting_table/candle2", <item:eidolon:candle>, [
    [<item:minecraft:string>],
    [<item:occultism:tallow>],
	[<item:minecraft:honeycomb>]
]);
...
craftingTable.addShaped("eidolon/crafting_table/pewter_inlay", <item:eidolon:pewter_inlay> * 2, [
