...
//Silver Ingot
blastFurnace.addRecipe("unify/blast_furnace/ingot/silver", <item:immersiveengineering:ingot_silver>, <item:exnihilosequentia:chunk_silver>, 1.0, 100);

//Aluminium Ingot
blastFurnace.addRecipe("unify/blast_furnace/ingot/alumiumium", <item:immersiveengineering:ingot_aluminum>, <item:exnihilosequentia:chunk_aluminum>, 1.0, 100);

//Nickel Ingot
blastFurnace.addRecipe("unify/blast_furnace/ingot/nickel", <item:immersiveengineering:ingot_nickel>, <item:exnihilosequentia:chunk_nickel>, 1.0, 100);