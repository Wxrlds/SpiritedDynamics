...
<recipetype:botania:mana_infusion>.addRecipe("botania/mana_infusion/manasteel/ingot", <item:botania:manasteel_ingot>, <item:eidolon:pewter_ingot>, 4500);

//Manasteel Block
<recipetype:botania:mana_infusion>.removeRecipe(<item:botania:manasteel_block>);
<recipetype:botania:mana_infusion>.addRecipe("botania/mana_infusion/manasteel/block", <item:botania:manasteel_block>, <item:eidolon:pewter_block>, 40500);
