...
<recipetype:alchemistry:combiner>.addJSONRecipe("immersiveengineering/combiner/redstoneenginneringblock",{
...
<recipetype:alchemistry:combiner>.addJSONRecipe("immersiveengineering/combiner/heavyenginneringblock",{
	"type": "alchemistry:combiner",
	"group": "minecraft:misc",
	"input": [
		{
...
<recipetype:alchemistry:combiner>.addJSONRecipe("immersiveengineering/combiner/lightenginneringblock",{
	"type": "alchemistry:combiner",
	"group": "minecraft:misc",
	"input": [
		{
