...
craftingTable.addShaped("mekanism/crafting_table/condiut/gas/ultimate", <item:mekanism:ultimate_pressurized_tube> * 16, [
    [<item:pipez:gas_pipe>, <item:pipez:gas_pipe>, <item:pipez:gas_pipe>],
    [<item:pipez:gas_pipe>, <item:pipez:ultimate_upgrade>, <item:pipez:gas_pipe>],
    [<item:pipez:gas_pipe>, <item:pipez:gas_pipe>, <item:pipez:gas_pipe>]
]);
