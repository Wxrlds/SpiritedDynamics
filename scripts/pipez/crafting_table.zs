...
craftingTable.addShaped("pipez/crafting_table/upgrade/ultimate", <item:pipez:ultimate_upgrade>, [
    [<tag:items:forge:dusts/netherite>, <tag:items:forge:storage_blocks/redstone>, <tag:items:forge:dusts/netherite>],
