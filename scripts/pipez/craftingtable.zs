...
craftingTable.addShaped("pipez/pipe/item", <item:pipez:item_pipe> * 16, [
...
craftingTable.addShaped("pipez/pipe/fluid", <item:pipez:fluid_pipe> * 16, [
	[<item:minecraft:iron_ingot>, <item:minecraft:iron_ingot>, <item:minecraft:iron_ingot>],
...
craftingTable.addShaped("pipez/pipe/energy", <item:pipez:energy_pipe> * 16, [
	[<item:minecraft:iron_ingot>, <item:minecraft:iron_ingot>, <item:minecraft:iron_ingot>],
...
craftingTable.addShaped("pipez/pipe/gas", <item:pipez:gas_pipe> * 16, [
	[<item:minecraft:iron_ingot>, <item:minecraft:iron_ingot>, <item:minecraft:iron_ingot>],
