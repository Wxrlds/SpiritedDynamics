...
// Copper
<tag:blocks:forge:ores/copper>.remove(<block:immersiveengineering:ore_copper>);
<tag:blocks:forge:ores/copper>.remove(<block:occultism:copper_ore>);
<tag:blocks:forge:ores>.remove(<block:immersiveengineering:ore_copper>);
<tag:blocks:forge:ores>.remove(<block:occultism:copper_ore>);
<tag:blocks:forge:storage_blocks/copper>.remove(<block:immersiveengineering:storage_copper>);
<tag:blocks:forge:storage_blocks/copper>.remove(<block:occultism:copper_block>);
<tag:blocks:forge:storage_blocks>.remove(<block:immersiveengineering:storage_copper>);
...
<tag:items:forge:storage_blocks/copper>.remove(<item:occultism:copper_block>);
<tag:items:forge:storage_blocks>.remove(<item:immersiveengineering:storage_copper>);
...
<tag:items:forge:dusts/gold>.remove(<item:occultism:gold_dust>);
...
<tag:items:forge:dusts/iron>.remove(<item:occultism:iron_dust>);
...
<tag:blocks:forge:ores>.remove(<block:immersiveengineering:ore_lead>);
...
// Netherite
<tag:items:bloodmagic:fragments/netherite_scrap>.remove(<item:bloodmagic:fragment_netherite_scrap>);
<tag:items:bloodmagic:gravels/netherite_scrap>.remove(<item:bloodmagic:gravel_netherite_scrap>);
...
// Steel
<tag:blocks:forge:storage_blocks/steel>.remove(<block:immersiveengineering:storage_steel>);
<tag:blocks:forge:storage_blocks>.remove(<block:immersiveengineering:storage_steel>);
<tag:items:forge:dusts/steel>.remove(<item:immersiveengineering:dust_steel>);
<tag:items:forge:dusts>.remove(<item:immersiveengineering:dust_steel>);
...
<tag:items:forge:nuggets/steel>.remove(<item:immersiveengineering:nugget_steel>);
<tag:items:forge:nuggets>.remove(<item:immersiveengineering:nugget_steel>);
<tag:items:forge:storage_blocks/steel>.remove(<item:immersiveengineering:storage_steel>);
...
<tag:blocks:forge:ores>.remove(<block:immersiveengineering:ore_uranium>);
...
val addItemTag as IItemStack[]=[
    ...
    <item:occultism:spawn_egg/afrit>,
    <item:occultism:spawn_egg/afrit_wild>,
    <item:occultism:spawn_egg/djinni>,
    <item:occultism:spawn_egg/familiar_bat>,
    <item:occultism:spawn_egg/familiar_beaver>,
    <item:occultism:spawn_egg/familiar_beholder>,
    <item:occultism:spawn_egg/familiar_blacksmith>,
    <item:occultism:spawn_egg/familiar_chimera>,
    <item:occultism:spawn_egg/familiar_cthulhu>,
    <item:occultism:spawn_egg/familiar_deer>,
    <item:occultism:spawn_egg/familiar_devil>,
    <item:occultism:spawn_egg/familiar_dragon>,
    <item:occultism:spawn_egg/familiar_fairy>,
    <item:occultism:spawn_egg/familiar_goat>,
    <item:occultism:spawn_egg/familiar_greedy>,
    <item:occultism:spawn_egg/familiar_guardian>,
    <item:occultism:spawn_egg/familiar_headless>,
    <item:occultism:spawn_egg/familiar_mummy>,
    <item:occultism:spawn_egg/familiar_shub_niggurath>,
    <item:occultism:spawn_egg/foliot>,
    <item:occultism:spawn_egg/marid>,
    <item:occultism:spawn_egg/otherworld_bird>,
    <item:occultism:spawn_egg/possessed_enderman>,
    <item:occultism:spawn_egg/possessed_endermite>,
    <item:occultism:spawn_egg/possessed_skeleton>,
    <item:occultism:spawn_egg/wild_hunt_skeleton>,
    <item:occultism:spawn_egg/wild_hunt_wither_skeleton>
];

for item in addItemTag {
    <tag:items:crafttweaker:spawn_eggs>.add(item);
}
